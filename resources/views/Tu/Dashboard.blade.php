<x-layout>
    ...
    <div class="flex flex-col items-center justify-center mt-6">
        <div class="flex flex-row px-8 justify-between mt-6">
            <div class="flex flex-col mx-3 items-center">
                <div class="bg-background-red2Bg rounded-t-xl shadow-lg w-full h-full flex-1 text-white text-center font-bold text-xl py-2 px-10">
                    Daftar Aduan
                </div>
                <div class="bg-background-red4Bg font-bold text-6xl text-black pt-8 pb-2 w-full h-full text-center">{{ $aduanBlmKirim }}</div>
                <div class="bg-background-red4Bg rounded-b-xl font-normal text-l text-black w-full h-full text-center py-2">Belum Dikirim</div>

                <div class="mt-5"> 
                    <a href='/aduan' id="daftar-aduan" class="bg-background-Green2Bg rounded-lg shadow-lg w-full text-white text-center hover:bg-button-hoverBtn py-3 px-10 text-md cursor-pointer">Lihat Detail </a>
                </div>
                <div class="mt-6 mb-10"> 
                    <a href='/aduan/tambah-aduan' id="tambah-aduan" class="bg-button-primaryBtn hover:bg-button-hoverPrimaryBtn rounded-lg shadow-lg w-full text-white text-center hover:bg-button-hoverBtn py-3 px-10 text-md cursor-pointer">Tambah Aduan</a>
                </div>
            </div>

            <div class="flex-1 min-w-[400px] max-w-[500px] max-h-[250px] overflow-y-auto mx-3">
            ...
            <!-- Kalender -->
            <div class="bg-background-yellow1Bg text-white rounded-3xl shadow-lg p-6 flex-1 min-w-[250px] max-w-[350px] mx-3">
                ...
                <div class="mt-6"> 
                    <a href='/tambah-jadwal-pengawas' id="tambah-aduan" class="bg-button-primaryBtn hover:bg-button-hoverPrimaryBtn rounded-lg shadow-lg w-full text-white text-center hover:bg-button-hoverBtn py-3 px-10 text-md cursor-pointer">Tambah Jadwal</a>
                </div>
            </div>
        </div>
